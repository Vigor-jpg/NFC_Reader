...
public class ReadActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        if(Ic_NfcAdapter!=null){
            ...
            if(Ic_NfcAdapter.isEnabled()){
                ...
                Toast.makeText(ReadActivity.this,"请检测手机NFC是否开启",Toast.LENGTH_LONG).show();
            }
        }else{
            Log.e(TAG,"onStart中Adapter不存在");
            Toast.makeText(ReadActivity.this,"请检测手机是否有NFC功能",Toast.LENGTH_LONG).show();
        }
    }
    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button=findViewById(R.id.btn_r);
        editText1=findViewById(R.id.text_r_num);
        editText2=findViewById(R.id.text_r_pass);
